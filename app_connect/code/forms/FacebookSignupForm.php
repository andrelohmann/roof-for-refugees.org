 ...
 */
class FacebookSignupForm extends BootstrapHorizontalForm {
 
    public function __construct($controller, $name, $fields = null, $actions = null) {
        
        $fields = new FieldList(
            $Nickname = TextField::create('Nickname')->setTitle(_t('Member.NICKNAME','Member.NICKNAME'))->setValue(Session::get('FormInfo.FacebookSignupForm.Nickname')),
    ...
    public function doSignup(array $data) {
        ...
        if(!$user = Session::get('FacebookUserData')) return $this->controller->redirect('facebook/error');
