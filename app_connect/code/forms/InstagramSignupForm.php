 ...
 */
class InstagramSignupForm extends BootstrapHorizontalForm {
 
    public function __construct($controller, $name, $fields = null, $actions = null) {
        
        $fields = new FieldList(
            $Nickname = TextField::create('Nickname')->setTitle(_t('Member.NICKNAME','Member.NICKNAME'))->setValue(Session::get('FormInfo.InstagramSignupForm.Nickname')),
    ...
    public function doSignup(array $data) {
        ...
        if(!$user = Session::get('InstagramUserData')) return $this->controller->redirect('instagram/error');
