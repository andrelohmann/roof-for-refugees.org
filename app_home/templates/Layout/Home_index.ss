        ...
        <div class="jumbotron">
            ...
            <div class="row">
                <div class="cols-xs-12 col-md-6">
                    <h5><%t Home.SIGNUPHEADLINE "Home.SIGNUPHEADLINE" %></h5>
                    $SignupForm
                </div>
                <div class="col-xs-12 col-md-6">
                    <h5><%t Home.LOGINHEADLINE "Home.LOGINHEADLINE" %></h5>
                    ...
                    <hr>
                    <h5><%t Home.LOGINWITHEMAIL "Home.LOGINWITHEMAIL" %></h5>
                    $LoginForm
                </div>
            </div>
            <br />
